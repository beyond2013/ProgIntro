...
|int isspace( int c );| Returns a true value if c is a whitespace character—newline ('_\\n_'), space (' '), form feed ('_\\f_'), carriage return ('_\\r_'), horizontal tab ('_\\t_') or vertical tab ('_\\v_')—and 0 otherwise.|
...
1. Function isspace determines whether a character is one of the following whitespace characters: space ( ' ' ), form feed ( '_\\f_' ), newline ( '_\\n_' ), carriage return ( '_\\r_' ), horizontal tab( '_\\t_' ) or vertical tab ( '_\\v_' ).
2. Function iscntrl determines whether a character is one of the following control characters: horizontal tab, vertical tab , form feed( '_\\f_' ), alert ( '_\\a_' ), backspace ( '_\\b_' ), carriage return ( '_\\r_' ) or newline ( '_\\n_' ).
...
```{#charfunctions .c .numberLines startFrom="1" }
#include <stdio.h>
#include <ctype.h>
...
```{#charfunctions2 .c .numberLines startFrom="1" }
#include <stdio.h>
#include <ctype.h>
int main( void )
{
...
```{#charfunctions3 .c .numberLines startFrom="1" }
#include <stdio.h>
#include <ctype.h>
int main( void )
{
...
```{#strtod .c .numberLines startFrom="1" }
#include <stdio.h>
#include <stdlib.h>
int main( void )
{
...
```{#strtol .c .numberLines startFrom="1" }
#include <stdio.h>
#include <stdlib.h>
int main( void )
{
...
```{#strtoul .c .numberLines startFrom="1" }
#include <stdio.h>
#include <stdlib.h>
int main( void )
{
...
```{#fgetsputs .c .numberLines startFrom="1" }
#include <stdio.h>
#define SIZE 80
...
```{#sprintf .c .numberLines startFrom="1" }
#include <stdio.h>
#define SIZE 80
int main( void )
{
...
```{#sscanf .c .numberLines startFrom="1" }
#include <stdio.h>
int main( void )
{
...
```{#strcpystrncpy .c .numberLines startFrom="1" }
#include <stdio.h>
#include <string.h>
#define SIZE1 25
#define SIZE2 15
...
```{#strchr .c .numberLines startFrom="1" }
#include <stdio.h>
#include <string.h>
int main( void )
{
...
```{#strcspn .c .numberLines startFrom="1" }
#include <stdio.h>
#include <string.h>
int main( void )
{
...
```{#strpbrk .c .numberLines startFrom="1" }
#include <stdio.h>
#include <string.h>
int main( void )
{
...
```{#strrchr .c .numberLines startFrom="1" }
#include <stdio.h>
#include <string.h>
int main( void )
{
...
```{#strspn .c .numberLines startFrom="1" }
#include <stdio.h>
#include <string.h>
int main( void )
{
...
```{#strstr .c .numberLines startFrom="1" }
#include <stdio.h>
#include <string.h>
int main( void )
{
...
```{#strtok .c .numberLines startFrom="1" }
#include <stdio.h>
#include <string.h>
int main( void )
{
